...
public final class FieldMapBlueFarFromScoringTableQuadrant extends FieldMapMiddleFarFromScoringTableHalf{
    ...
    public double getTotalDistanceFromFrontOfBotToNullBump() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_TOTAL_DISTANCE_FROM_ROBOT_STARTING_POINT_TO_NULL_BUMP;
    }

    @Override
    public double getDistanceFromLineSensorToNullTerritoryLine() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_LINE_SENSOR_TO_NULL_TERRITORY_LINE;
    }

    @Override
    public double getAngleToTurnToReachScaleEdge() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DEGREE_OF_ANGLE_TO_TURN_IN_NULL_TERRITORY;
    }

    @Override
    public double getDistanceToMoveBackward() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_TO_TRAVEL_BACKWARDS;
    }
    ...
    public double getTotalDistanceToTravelAcrossPlatformZoneToReachSwitch() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_TOTAL_DISTANCE_TO_TRAVEL_ACROSS_PLATFORM_ZONE_TO_SWITCH;
    }

    @Override
    public double getAngleToReachSwitch() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DEGREE_OF_ANGLE_TO_REACH_SWITCH;
    }

    @Override
    public double getDistanceToTravelToReachSwitch() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_TO_REACH_SWITCH;
    }

    @Override
    public double getAngleToReachSwitchEdge() {
        return BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DEGREE_OF_ANGLE_TO_REACH_SWITCH_EDGE;
    }
    //**************************************************************************************************************
...
/* Given FRC Manual Measurements*/
    ...
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_SWITCH_EDGE = 85.25;
    ...
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT = 29.69 + 12.0; //
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_SWITCH_SIDE = 140.0; //
    ...
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_AUTO_LINE_TO_NULL_TERRITORY_LINE = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY - BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE;
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_FRONT_OF_BOT_TO_AUTO_LINE = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - RobotMap.LENGTH_OF_BOT;
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_TOTAL_DISTANCE_FROM_ROBOT_STARTING_POINT_TO_NULL_BUMP = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_FRONT_OF_BOT_TO_AUTO_LINE + RobotMap.MIDDLE_OF_BOT_LENGTHWISE;
    ...
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_TOTAL_DISTANCE_TO_MOVE_TO_REACH_SCALE_EDGE = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_SWITCH_EDGE - BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT - (RobotMap.WIDTH_OF_BOT + RobotMap.DIFFERENCE_BETWEEN_LENGTH_OF_ROBOT_AND_WIDTH_OF_ROBOT_AFTER_TURN);
    
    //Switch auton where the bot is on different sides as the scoring switch
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_TO_DRIVE_OUT_TO_REACH_SWITCH = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_PLATFORM_ZONE_EDGE - BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT;
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_TOTAL_DISTANCE_TO_TRAVEL_ACROSS_PLATFORM_ZONE_TO_SWITCH = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_TO_TRAVEL_TO_REACH_PLATFORM_ZONE_EDGE_AFTER_TURN + BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_PLATFORM_ZONE_EDGE_TO_OTHER + BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_TO_DRIVE_OUT_TO_REACH_SWITCH + RobotMap.DIFFERENCE_BETWEEN_LENGTH_OF_ROBOT_AND_WIDTH_OF_ROBOT_AFTER_TURN;
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DEGREE_OF_ANGLE_TO_REACH_SWITCH = 90;
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_TO_REACH_SWITCH = (BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_FAR_SIDE_OF_SWITCH - BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_MIDDLE_OF_SWITCH) + BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_FAR_SIDE_OF_SWITCH_TO_PLATFORM_EDGE_HALVED;
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DEGREE_OF_ANGLE_TO_REACH_SWITCH_EDGE = 90;
    ...
    private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_TOTAL_DISTANCE_TO_TRAVEL_TO_REACH_NULL_TERRITORY_LINE = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_LINE_SENSOR_TO_AUTO_LINE + BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_AUTO_LINE_TO_NULL_TERRITORY - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT;
        ...
        //Backup
        private static final double BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_LINE_SENSOR_TO_NULL_TERRITORY_LINE = BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_AUTO_LINE_TO_NULL_TERRITORY_LINE + BLUE_FAR_FROM_SCORING_TABLE_QUADRANT_DISTANCE_FROM_LINE_SENSOR_TO_AUTO_LINE;
    //**************************************************************************************************************
}
