...
/* Given FRC Manual Measurements*/
    ...
    public static final double DISTANCE_BETWEEN_SCALE_SIDE_AND_NULL_TERRITORY = DISTANCE_FROM_ALLIANCE_STATION_TO_SCALE_SIDE - DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY;
    ...
    public static final int DISTANCE_BETWEEN_NULL_BUMP_AND_AUTO_LINE = 204; //
    public static final double DISTANCE_BETWEEN_BORDER_AND_SCALE_EDGE = 71.57; //
    ...
    public static final int DISTANCE_BETWEEN_NULL_TERRITORY_AND_AUTO_LINE = DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY - DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE;
    public static final double DISTANCE_BETWEEN_ROBOT_STARTING_POINT_AND_PLATFORM_ZONE_EDGE = DISTANCE_FROM_BORDER_TO_PLATFORM_ZONE_EDGE - DISTANCE_FROM_BORDER_TO_ROBOT_STARTING_POINT;
    public static final double DISTANCE_BETWEEN_NULL_TERRITORY_AND_AUTO_LINE_SQUARED = DISTANCE_BETWEEN_NULL_TERRITORY_AND_AUTO_LINE * DISTANCE_BETWEEN_NULL_TERRITORY_AND_AUTO_LINE;
    public static final double DISTANCE_BETWEEN_ROBOT_STARTING_POINT_AND_PLATFORM_ZONE_EDGE_SQUARED = DISTANCE_BETWEEN_ROBOT_STARTING_POINT_AND_PLATFORM_ZONE_EDGE * DISTANCE_BETWEEN_ROBOT_STARTING_POINT_AND_PLATFORM_ZONE_EDGE;
    public static final double DISTANCE_TO_TRAVEL_TO_REACH_PLATFORM_ZONE_EDGE_FROM_AUTO_LINE_SQUARED = DISTANCE_BETWEEN_NULL_TERRITORY_AND_AUTO_LINE_SQUARED + DISTANCE_BETWEEN_ROBOT_STARTING_POINT_AND_PLATFORM_ZONE_EDGE_SQUARED;
    ...
    public static final double DEGREE_OF_ANGLE_TO_REACH_PLATFORM_ZONE_EDGE_FROM_AUTO_LINE = -1 * Math.atan(DISTANCE_BETWEEN_ROBOT_STARTING_POINT_AND_PLATFORM_ZONE_EDGE / DISTANCE_BETWEEN_NULL_TERRITORY_AND_AUTO_LINE);
    
    //Scale auton where the bot is on the other side of the alliance scale
    public static final int DISTANCE_BETWEEN_AUTO_LINE_AND_FAR_SIDE_OF_SWITCH = DISTANCE_FROM_ALLIANCE_STATION_TO_FAR_SIDE_OF_SWITCH - DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE;
    public static final double DISTANCE_BETWEEN_FAR_SIDE_OF_SWITCH_AND_PLATFORM = DISTANCE_FROM_ALLIANCE_STATION_TO_PLATFORM_EDGE - DISTANCE_FROM_ALLIANCE_STATION_TO_FAR_SIDE_OF_SWITCH;
    public static final double DISTANCE_BETWEEN_FAR_SIDE_OF_SWITCH_AND_PLATFORM_HALVED = DISTANCE_BETWEEN_FAR_SIDE_OF_SWITCH_AND_PLATFORM / 2;
    public static final double DISTANCE_TO_TRAVEL_BEFORE_FIRST_TURN = DISTANCE_BETWEEN_AUTO_LINE_AND_FAR_SIDE_OF_SWITCH + DISTANCE_BETWEEN_FAR_SIDE_OF_SWITCH_AND_PLATFORM_HALVED; 
    public static final double DISTANCE_BETWEEN_PLATFORM_ZONE_EDGE_AND_SCALE_EDGE = DISTANCE_FROM_BORDER_TO_PLATFORM_ZONE_EDGE - DISTANCE_BETWEEN_BORDER_AND_SCALE_EDGE;
