...
/* Given FRC Manual Measurements*/
    ...
    public static final double DISTANCE_TO_MOVE_OUT = DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - Math.atan(DEGREE_OF_ANGLE_TO_REACH_IDEAL_STARTING_POINT_FROM_AUTO_LINE * DISTANCE_FROM_CENTER_OF_FIELD_TO_ROBOT_STARTING_POINT);
    public static final double DISTANCE_FROM_ROBOT_TURNING_TO_AUTO_LINE = DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - DISTANCE_TO_MOVE_OUT;
    ...
    public static final double DEGREE_OF_ANGLE_TO_REACH_SCALE_AUTON = 90 - DEGREE_OF_ANGLE_TO_REACH_IDEAL_STARTING_POINT_FROM_AUTO_LINE;
