...
/* Given FRC Manual Measurements*/
  ...
  //public static final int DISTANCE_FROM_NULL_BUMP_TO_AUTO_LINE = 204; //
    ...
    public static final double DISTANCE_FROM_BORDER_TO_OTHER_EDGE_OF_ROBOT = DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT + RobotMap.WIDTH_OF_BOT;
    ...
    public static final double DISTANCE_FROM_LINE_SENSOR_TO_AUTO_LINE = DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - (RobotMap.LENGTH_OF_BOT - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT);
    ...
    public static final double DISTANCE_FROM_FRONT_OF_ROBOT_TO_AUTO_LINE = DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - RobotMap.LENGTH_OF_BOT;
    public static final double DISTANCE_FROM_AUTO_LINE_TO_NULL_TERRITORY = DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY - DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE;
    ...
    public static final double DISTANCE_TO_TRAVEL_BEFORE_FIRST_TURN_FROM_AUTO_LINE = DISTANCE_FROM_AUTO_LINE_TO_FAR_SIDE_OF_SWITCH + DISTANCE_FROM_FAR_SIDE_OF_SWITCH_TO_PLATFORM_EDGE_HALVED + (MIDDLE_OF_BOT_LENGTHWISE - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT); 
    public static final double DISTANCE_TO_TRAVEL_TO_REACH_PLATFORM_ZONE_EDGE_AFTER_TURN = (DISTANCE_FROM_BORDER_TO_PLATFORM_ZONE_EDGE - (DISTANCE_FROM_BORDER_TO_OTHER_EDGE_OF_ROBOT + 2.5)) + RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT;
