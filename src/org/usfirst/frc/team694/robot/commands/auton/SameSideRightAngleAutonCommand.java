...
public class SameSideRightAngleAutonCommand extends CommandGroup {
    ...
    public SameSideRightAngleAutonCommand() {
        ...
        addSequential(new DrivetrainMoveToLineCommand(FieldMap.DISTANCE_FROM_NULL_TERRITORY_TO_AUTO_LINE, speed));
        ...
        addParallel(new LiftMoveToHeightCommand(RobotMap.MAX_HEIGHT_OF_LIFT));
