 ...
 *
 */
public abstract class DrivetrainRotateDegreesControlSpeedPIDCommand extends Command {
    ...
    public DrivetrainRotateDegreesControlSpeedPIDCommand(double targetAngle, double speedChange) {
        super(targetAngle);
