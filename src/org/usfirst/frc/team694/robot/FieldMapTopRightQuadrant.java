...
/* Given FRC Manual Measurements*/
    ...
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_MIDDLE_OF_FIELD = 162.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_PLATFORM_ZONE_EDGE_TO_BUMP = 66.75; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_MIDDLE_OF_SWITCH = 168.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY = 288.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE = 120.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_SWITCH = 140.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_FAR_SIDE_OF_SWITCH = 196.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_PLATFORM_EDGE = 261.47; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_SCALE_SIDE = 299.65; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_NULL_TERRITORY_TO_NULL_BUMP = 36.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_SWITCH_EDGE = 85.25; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_PLATFORM_ZONE_EDGE = 95.25; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT = 29.69; //
  //public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_NULL_BUMP_TO_AUTO_LINE = 204.0; //
    
    //**************************************************************************************************************
    
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_OTHER_EDGE_OF_ROBOT = TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT + RobotMap.WIDTH_OF_BOT;
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_ROBOT_STARTING_POINT = TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT + FieldMap.MIDDLE_OF_BOT_WIDTHWISE; //
    
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_SCALE_SIDE_TO_NULL_TERRITORY = TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_SCALE_SIDE - TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY;
    ...
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_LINE_SENSOR_TO_AUTO_LINE = TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - (RobotMap.LENGTH_OF_BOT - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT);
   
    //**************************************************************************************************************
    //Scale auton where the bot is on the same side as the alliance scale and bot will be in the null territory
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_NULL_BUMP_TO_AUTO_LINE = 204.0; //
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_MOVE_INTO_NULL_BUMP = FieldMap.MIDDLE_OF_BOT_LENGTHWISE - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT;
    public static final int TOP_RIGHT_QUADRANT_DEGREE_OF_ANGLE_TO_TURN_IN_NULL_TERRITORY = -90;
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_TRAVEL_BACKWARDS = TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT - FieldMap.DIFFERENCE_BETWEEN_LENGTH_OF_ROBOT_AND_WIDTH_OF_ROBOT_AFTER_TURN; 
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_TRAVEL_TO_REACH_SCALE_EDGE = FieldMapTopMiddleQuadrant.TOP_MIDDLE_QUADRANT_DISTANCE_FROM_BORDER_TO_SCALE_EDGE - RobotMap.LENGTH_OF_BOT;
    
    //Scale auton where the bot is on the same side as the alliance scale and bot will turn at null territory line
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_FRONT_OF_ROBOT_TO_AUTO_LINE = TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE - RobotMap.LENGTH_OF_BOT;
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_AUTO_LINE_TO_NULL_TERRITORY = TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_NULL_TERRITORY - TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE;
    ...
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_AUTO_LINE_TO_FAR_SIDE_OF_SWITCH = TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_FAR_SIDE_OF_SWITCH - TOP_RIGHT_QUADRANT_DISTANCE_FROM_ALLIANCE_STATION_TO_AUTO_LINE;
    ...
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_DRIVE_OUT_AFTER_PLATFORM_ZONE = RobotMap.WIDTH_OF_BOT - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT; 
    public static final int TOP_RIGHT_QUADRANT_DEGREE_OF_ANGLE_TO_TURN_TO_REACH_SCALE_SIDE = 90;
    public static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_TRAVEL_TO_REACH_SCALE_SIDE = FieldMapBottomRightQuadrant.BOTTOM_RIGHT_QUADRANT_DISTANCE_FROM_FAR_SIDE_OF_SWITCH_TO_SCALE_SIDE - FieldMapBottomRightQuadrant.BOTTOM_RIGHT_QUADRANT_DISTANCE_FROM_FAR_SIDE_OF_SWITCH_TO_PLATFORM_EDGE_HALVED;
}
