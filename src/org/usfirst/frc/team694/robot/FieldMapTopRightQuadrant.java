...
/* Given FRC Manual Measurements*/
  ...
  //private static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_NULL_BUMP_TO_AUTO_LINE = 204.0; //
    ...
    private static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_ROBOT_STARTING_POINT = TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT + RobotMap.MIDDLE_OF_BOT_WIDTHWISE; //
    ...
    private static final double TOP_RIGHT_QUADRANT_DISTANCE_FROM_NULL_BUMP_TO_AUTO_LINE = 204.0; //
    private static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_MOVE_INTO_NULL_BUMP = RobotMap.MIDDLE_OF_BOT_LENGTHWISE - RobotMap.DISTANCE_LINE_SENSOR_IS_FROM_FRONT_BUMPER_OF_BOT;
    private static final int TOP_RIGHT_QUADRANT_DEGREE_OF_ANGLE_TO_TURN_IN_NULL_TERRITORY = 90;
    private static final double TOP_RIGHT_QUADRANT_DISTANCE_TO_TRAVEL_BACKWARDS = TOP_RIGHT_QUADRANT_DISTANCE_FROM_BORDER_TO_EDGE_OF_ROBOT - RobotMap.DIFFERENCE_BETWEEN_LENGTH_OF_ROBOT_AND_WIDTH_OF_ROBOT_AFTER_TURN; 
