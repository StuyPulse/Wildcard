 ...
 */
public abstract class FieldMapMiddleNearScoringTableHalf implements FieldMapInterface {
...
/* Given FRC Manual Measurements*/
    ...
    public double getDistanceFromBorderToScaleEdge() {
        return MIDDLE_NEAR_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_SCALE_EDGE;
    }
    final double MIDDLE_NEAR_SCORING_TABLE_QUADRANT_DISTANCE_FROM_BORDER_TO_SCALE_EDGE = 71.57; //
}